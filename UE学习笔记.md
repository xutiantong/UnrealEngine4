...
![Untitled5.png](./MarkDownImg/Untitled5.png)
...
![Untitled6.png](./MarkDownImg/Untitled6.png)

## 人物

- 人物控制蓝图：

![Untitled7.png](./MarkDownImg/Untitled7.png)

根据第三人称模版，自己熟悉并书写了一遍

- 人物视角：默认Pawn类中设置为跟随人物移动的视角，既肩旁朝向，通过修改为使用Controller视角，可以改变人物视角为屏幕视角，也可封装为简单函数进行使用。

![Untitled8.png](./MarkDownImg/Untitled8.png)
...
![Untitled9.png](./MarkDownImg/Untitled9.png)

- 特殊攻击：攻击中按下右键，本次攻击完后取消连招，播放指定的特殊攻击动画。

![Untitled10.png](./MarkDownImg/Untitled10.png)

- 重置连招：在动画播放完后，如果没有控制攻击，则重置连招。

![Untitled11.png](./MarkDownImg/Untitled11.png)
...
![Untitled14.png](./MarkDownImg/Untitled14.png)

计算夹角

![Untitled15.png](./MarkDownImg/Untitled15.png)
...
![Untitled16.png](./MarkDownImg/Untitled16.png)

## AI

- 三件套：AIController、行为树、黑板，AIController为控制器，可为Pawn添加。行为树控制AI的逻辑，既有限状态机，黑板则用来储存数据，方便行为树的执行和判断。

![Untitled17.png](./MarkDownImg/Untitled17.png)

- 行为树中的节点：

![Untitled18.png](./MarkDownImg/Untitled18.png)

- 简单AI：如果受击则无作为，未看到玩家进行随机巡逻，看到玩家会追逐玩家，根据冷却时间和距离进行近战及远程攻击。（自动寻路范围需要提前在场景内进行烘焙）

![Untitled19.png](./MarkDownImg/Untitled19.png)
